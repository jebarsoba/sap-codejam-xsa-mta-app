sap.ui.define([
	...
	return BaseObject.extend("web.model.GroupSortState", {
		 ...
		 * @alias web.model.GroupSortState
		 */
		...
		/**
		 * Sorts by APPROVALSTATUS, or by GROSSAMOUNT
		 *
		...
		group: function (sKey) {
			...
			if (sKey === "GROSSAMOUNT") {
				...
				this._oViewModel.setProperty("/sortBy", "APPROVALSTATUS");
			}
